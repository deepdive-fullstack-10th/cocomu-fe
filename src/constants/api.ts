...
export const STOMP_ENDPOINTS = {
  ...
  TAB_SUBSCRIBE: (codingSpaceTabId: string) => `/sub/v1/executor/${codingSpaceTabId}`,
  SUBMISSION_SUBSCRIBE: (codingSpaceTabId: string) => `/sub/v1/executor/${codingSpaceTabId}/submission`,
} as const;
